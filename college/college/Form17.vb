...
Public Class Form17
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        c1 = CInt(ComboBox3.SelectedItem.ToString())
        str = "insert into student values('" & CInt(TextBox1.Text) & "','" & TextBox2.Text & "','" & c2 & "',
" & CInt(TextBox4.Text) & ",'" & TextBox6.Text & "','" & TextBox9.Text & "',
'" & TextBox5.Text & "','" & c3 & "'," & c1 & ",'" & TextBox7.Text & "','" & TextBox3.Text & "')"
