...
Partial Public Class feesDataSet1
    ...
    Partial Public Class feesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddfeesRow(ByVal ID As String, ByVal fees As Integer, ByVal f_i_w As String) As feesRow
...
Namespace feesDataSet1TableAdapters
    ...
    Partial Public Class feesTableAdapter
        ...
        Public Overloads Overridable Function Insert(ByVal ID As String, ByVal fees As Global.System.Nullable(Of Integer), ByVal f_i_w As String) As Integer
            ...
            If (fees.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(fees.Value,Integer)
            Else
