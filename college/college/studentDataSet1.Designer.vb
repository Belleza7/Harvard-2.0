...
Partial Public Class studentDataSet1
    ...
    Partial Public Class studentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddstudentRow(ByVal ID As Integer, ByVal Dob As Date, ByVal gender As String, ByVal age As Integer, ByVal mob_no As Integer, ByVal address As String, ByVal s_name As String, ByVal dept As String, ByVal batch As Integer, ByVal m_name As String, ByVal f_name As String) As studentRow
            Dim rowstudentRow As studentRow = CType(Me.NewRow,studentRow)
            Dim columnValuesArray() As Object = New Object() {ID, Dob, gender, age, mob_no, address, s_name, dept, batch, m_name, f_name}
        ...
        Private Sub InitClass()
            ...
            Me.columnmob_no = New Global.System.Data.DataColumn("mob_no", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class studentRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Property mob_no() As Integer
            Get
                Try 
                    Return CType(Me(Me.tablestudent.mob_noColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'mob_no' in table 'student' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablestudent.mob_noColumn) = value
            End Set
        End Property
        ...
        Public Property batch() As Integer
            Get
                Try 
                    Return CType(Me(Me.tablestudent.batchColumn),Integer)
                Catch e As Global.System.InvalidCastException
        ...
        Public Function Ismob_noNull() As Boolean
            Return Me.IsNull(Me.tablestudent.mob_noColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub Setmob_noNull()
            Me(Me.tablestudent.mob_noColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace studentDataSet1TableAdapters
    ...
    Partial Public Class studentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `student` WHERE ((`ID` = ?) AND ((? = 1 AND `Dob` IS NULL) OR (`Dob` "& _ 
                "= ?)) AND ((? = 1 AND `gender` IS NULL) OR (`gender` = ?)) AND ((? = 1 AND `age`"& _ 
                " IS NULL) OR (`age` = ?)) AND ((? = 1 AND `mob_no` IS NULL) OR (`mob_no` = ?)) A"& _ 
                "ND ((? = 1 AND `s_name` IS NULL) OR (`s_name` = ?)) AND ((? = 1 AND `dept` IS NU"& _ 
                "LL) OR (`dept` = ?)) AND ((? = 1 AND `batch` IS NULL) OR (`batch` = ?)) AND ((? "& _ 
                "= 1 AND `m_name` IS NULL) OR (`m_name` = ?)) AND ((? = 1 AND `f_name` IS NULL) O"& _ 
                "R (`f_name` = ?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_mob_no", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "mob_no", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_mob_no", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "mob_no", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_batch", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "batch", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `student` (`ID`, `Dob`, `gender`, `age`, `mob_no`, `address`, `s_name"& _ 
                "`, `dept`, `batch`, `m_name`, `f_name`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"& _ 
                ""
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("mob_no", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "mob_no", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("batch", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "batch", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `student` SET `ID` = ?, `Dob` = ?, `gender` = ?, `age` = ?, `mob_no` = ?, "& _ 
                "`address` = ?, `s_name` = ?, `dept` = ?, `batch` = ?, `m_name` = ?, `f_name` = ?"& _ 
                " WHERE ((`ID` = ?) AND ((? = 1 AND `Dob` IS NULL) OR (`Dob` = ?)) AND ((? = 1 AN"& _ 
                "D `gender` IS NULL) OR (`gender` = ?)) AND ((? = 1 AND `age` IS NULL) OR (`age` "& _ 
                "= ?)) AND ((? = 1 AND `mob_no` IS NULL) OR (`mob_no` = ?)) AND ((? = 1 AND `s_na"& _ 
                "me` IS NULL) OR (`s_name` = ?)) AND ((? = 1 AND `dept` IS NULL) OR (`dept` = ?))"& _ 
                " AND ((? = 1 AND `batch` IS NULL) OR (`batch` = ?)) AND ((? = 1 AND `m_name` IS "& _ 
                "NULL) OR (`m_name` = ?)) AND ((? = 1 AND `f_name` IS NULL) OR (`f_name` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("mob_no", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "mob_no", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("batch", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "batch", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_mob_no", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "mob_no", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_mob_no", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "mob_no", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_batch", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "batch", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.college.My.MySettings.Default.studentConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Dob, gender, age, mob_no, address, s_name, dept, batch, m_name, f_name"& _ 
                " FROM student"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Dob As Global.System.Nullable(Of Date), ByVal Original_gender As String, ByVal Original_age As Global.System.Nullable(Of Integer), ByVal Original_mob_no As Global.System.Nullable(Of Integer), ByVal Original_s_name As String, ByVal Original_dept As String, ByVal Original_batch As Global.System.Nullable(Of Integer), ByVal Original_m_name As String, ByVal Original_f_name As String) As Integer
            ...
            If (Original_mob_no.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_mob_no.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_s_name,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(12).Value = CType(Original_dept,String)
            End If
            If (Original_batch.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(13).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(14).Value = CType(Original_batch.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(18).Value = CType(Original_f_name,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal ID As Integer, ByVal Dob As Global.System.Nullable(Of Date), ByVal gender As String, ByVal age As Global.System.Nullable(Of Integer), ByVal mob_no As Global.System.Nullable(Of Integer), ByVal address As String, ByVal s_name As String, ByVal dept As String, ByVal batch As Global.System.Nullable(Of Integer), ByVal m_name As String, ByVal f_name As String) As Integer
            ...
            If (mob_no.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(mob_no.Value,Integer)
            Else
            ...
            End If
            If (batch.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(8).Value = CType(batch.Value,Integer)
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(9).Value = CType(m_name,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal mob_no As Global.System.Nullable(Of Integer),  _
                    ByVal address As String,  _
                    ByVal s_name As String,  _
                    ByVal dept As String,  _
                    ByVal batch As Global.System.Nullable(Of Integer),  _
                    ...
                    ByVal Original_mob_no As Global.System.Nullable(Of Integer),  _
                    ByVal Original_s_name As String,  _
                    ByVal Original_dept As String,  _
                    ByVal Original_batch As Global.System.Nullable(Of Integer),  _
                    ByVal Original_m_name As String,  _
                    ByVal Original_f_name As String) As Integer
            ...
            End If
            If (mob_no.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(mob_no.Value,Integer)
            Else
            ...
            End If
            If (batch.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(batch.Value,Integer)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(m_name,String)
            End If
            If (f_name Is Nothing) Then
            ...
            If (Original_mob_no.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_mob_no.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(23).Value = CType(Original_dept,String)
            End If
            If (Original_batch.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(25).Value = CType(Original_batch.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(27).Value = CType(Original_m_name,String)
            End If
            If (Original_f_name Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(29).Value = CType(Original_f_name,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_m_name As String,  _
                    ByVal Original_f_name As String) As Integer
            Return Me.Update(Original_ID, Dob, gender, age, mob_no, address, s_name, dept, batch, m_name, f_name, Original_ID, Original_Dob, Original_gender, Original_age, Original_mob_no, Original_s_name, Original_dept, Original_batch, Original_m_name, Original_f_name)
        End Function
    End Class
